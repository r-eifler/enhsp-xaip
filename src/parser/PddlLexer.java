...
public class PddlLexer extends Lexer {
	...
	public final void mT__105() throws RecognitionException {
		try {
			int _type = T__105;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:48:8: ( 'decrease' )
			// Pddl.g:48:10: 'decrease'
			{
			match("decrease"); 
	...
	public final void mT__112() throws RecognitionException {
		try {
			int _type = T__112;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:55:8: ( 'hold-after' )
			// Pddl.g:55:10: 'hold-after'
			{
			match("hold-after"); 
	...
	public final void mT__113() throws RecognitionException {
		try {
			int _type = T__113;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:56:8: ( 'hold-during' )
			// Pddl.g:56:10: 'hold-during'
			{
			match("hold-during"); 
	...
	public final void mT__115() throws RecognitionException {
		try {
			int _type = T__115;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:58:8: ( 'increase' )
			// Pddl.g:58:10: 'increase'
			{
			match("increase"); 
	...
	public final void mT__116() throws RecognitionException {
		try {
			int _type = T__116;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:59:8: ( 'is-violated' )
			// Pddl.g:59:10: 'is-violated'
			{
			match("is-violated"); 
	...
	public final void mT__117() throws RecognitionException {
		try {
			int _type = T__117;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:60:8: ( 'maximize' )
			// Pddl.g:60:10: 'maximize'
			{
			match("maximize"); 
	...
	public final void mT__123() throws RecognitionException {
		try {
			int _type = T__123;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:66:8: ( 'preference' )
			// Pddl.g:66:10: 'preference'
			{
			match("preference"); 
	...
	public final void mT__125() throws RecognitionException {
		try {
			int _type = T__125;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:68:8: ( 'scale-down' )
			// Pddl.g:68:10: 'scale-down'
			{
			match("scale-down"); 
	...
	public final void mT__126() throws RecognitionException {
		try {
			int _type = T__126;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:69:8: ( 'scale-up' )
			// Pddl.g:69:10: 'scale-up'
			{
			match("scale-up"); 
	...
	public final void mT__127() throws RecognitionException {
		try {
			int _type = T__127;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:70:8: ( 'sometime' )
			// Pddl.g:70:10: 'sometime'
			{
			match("sometime"); 
	...
	public final void mT__128() throws RecognitionException {
		try {
			int _type = T__128;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:71:8: ( 'sometime-after' )
			// Pddl.g:71:10: 'sometime-after'
			{
	...
	public final void mT__129() throws RecognitionException {
		try {
			int _type = T__129;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:72:8: ( 'sometime-before' )
			// Pddl.g:72:10: 'sometime-before'
			{
	...
	public final void mREQUIRE_KEY() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:557:5: ( ':strips' | ':typing' | ':negative-preconditions' | ':disjunctive-preconditions' | ':equality' | ':existential-preconditions' | ':universal-preconditions' | ':quantified-preconditions' | ':conditional-effects' | ':fluents' | ':adl' | ':durative-actions' | ':derived-predicates' | ':timed-initial-literals' | ':preferences' | ':constraints' )
			int alt1=16;
			...
			switch (alt1) {
				...
				case 2 :
					...
					break;
				case 3 :
					// Pddl.g:559:7: ':negative-preconditions'
					{
					...
					break;
				case 4 :
					// Pddl.g:560:7: ':disjunctive-preconditions'
					{
				...
				case 5 :
					...
					break;
				case 6 :
					// Pddl.g:562:7: ':existential-preconditions'
					{
					...
					break;
				case 7 :
					// Pddl.g:563:7: ':universal-preconditions'
					{
					...
					break;
				case 8 :
					// Pddl.g:564:7: ':quantified-preconditions'
					{
					...
					break;
				case 9 :
					// Pddl.g:565:7: ':conditional-effects'
					{
				...
				case 12 :
					...
					break;
				case 13 :
					// Pddl.g:569:7: ':derived-predicates'
					{
					...
					break;
				case 14 :
					// Pddl.g:570:7: ':timed-initial-literals'
					{
	...
	public final void mNAME() throws RecognitionException {
		try {
			int _type = NAME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:573:5: ( LETTER ( ANY_CHAR )* )
			// Pddl.g:573:10: LETTER ( ANY_CHAR )*
			{
			mLETTER(); 

			// Pddl.g:573:17: ( ANY_CHAR )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mVARIABLE() throws RecognitionException {
		try {
			...
			// Pddl.g:579:12: '?' LETTER ( ANY_CHAR )*
			{
			match('?'); 
			mLETTER(); 

			// Pddl.g:579:23: ( ANY_CHAR )*
			loop3:
			while (true) {
				int alt3=2;
