// $ANTLR 3.5 Pddl.g 2014-03-24 16:49:39
 package parser; 
...
public class PddlLexer extends Lexer {
	...
	public final void mT__79() throws RecognitionException {
		try {
			int _type = T__79;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:27:7: ( ':requirements' )
			// Pddl.g:27:9: ':requirements'
			{
			match(":requirements"); 
	...
	public final void mT__86() throws RecognitionException {
		try {
			int _type = T__86;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:34:7: ( '?duration' )
			// Pddl.g:34:9: '?duration'
			{
			match("?duration"); 
	...
	public final void mT__89() throws RecognitionException {
		try {
			int _type = T__89;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:37:7: ( 'always-within' )
			// Pddl.g:37:9: 'always-within'
			{
			match("always-within"); 
	...
	public final void mT__93() throws RecognitionException {
		try {
			int _type = T__93;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:41:7: ( 'at-most-once' )
			// Pddl.g:41:9: 'at-most-once'
			{
			match("at-most-once"); 
	...
	public final void mT__94() throws RecognitionException {
		try {
			int _type = T__94;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:42:7: ( 'decrease' )
			// Pddl.g:42:9: 'decrease'
			{
			match("decrease"); 
	...
	public final void mT__101() throws RecognitionException {
		try {
			int _type = T__101;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:49:8: ( 'hold-after' )
			// Pddl.g:49:10: 'hold-after'
			{
			match("hold-after"); 
	...
	public final void mT__102() throws RecognitionException {
		try {
			int _type = T__102;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:50:8: ( 'hold-during' )
			// Pddl.g:50:10: 'hold-during'
			{
			match("hold-during"); 
	...
	public final void mT__104() throws RecognitionException {
		try {
			int _type = T__104;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:52:8: ( 'increase' )
			// Pddl.g:52:10: 'increase'
			{
			match("increase"); 
	...
	public final void mT__105() throws RecognitionException {
		try {
			int _type = T__105;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:53:8: ( 'is-violated' )
			// Pddl.g:53:10: 'is-violated'
			{
			match("is-violated"); 
	...
	public final void mT__106() throws RecognitionException {
		try {
			int _type = T__106;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:54:8: ( 'maximize' )
			// Pddl.g:54:10: 'maximize'
			{
			match("maximize"); 
	...
	public final void mT__107() throws RecognitionException {
		try {
			int _type = T__107;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:55:8: ( 'minimize' )
			// Pddl.g:55:10: 'minimize'
			{
			match("minimize"); 
	...
	public final void mREQUIRE_KEY() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:515:5: ( ':strips' | ':typing' | ':negative-preconditions' | ':disjunctive-preconditions' | ':equality' | ':existential-preconditions' | ':universal-preconditions' | ':quantified-preconditions' | ':conditional-effects' | ':fluents' | ':adl' | ':durative-actions' | ':derived-predicates' | ':timed-initial-literals' | ':preferences' | ':constraints' )
			int alt1=16;
			...
			switch (alt1) {
				...
				case 2 :
					...
					break;
				case 3 :
					// Pddl.g:517:7: ':negative-preconditions'
					{
					...
					break;
				case 4 :
					// Pddl.g:518:7: ':disjunctive-preconditions'
					{
				...
				case 5 :
					...
					break;
				case 6 :
					// Pddl.g:520:7: ':existential-preconditions'
					{
					...
					break;
				case 7 :
					// Pddl.g:521:7: ':universal-preconditions'
					{
					...
					break;
				case 8 :
					// Pddl.g:522:7: ':quantified-preconditions'
					{
					...
					break;
				case 9 :
					// Pddl.g:523:7: ':conditional-effects'
					{
				...
				case 12 :
					...
					break;
				case 13 :
					// Pddl.g:527:7: ':derived-predicates'
					{
					...
					break;
				case 14 :
					// Pddl.g:528:7: ':timed-initial-literals'
					{
	...
	public final void mNAME() throws RecognitionException {
		try {
			int _type = NAME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:531:5: ( LETTER ( ANY_CHAR )* )
			// Pddl.g:531:10: LETTER ( ANY_CHAR )*
			{
			mLETTER(); 

			// Pddl.g:531:17: ( ANY_CHAR )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mVARIABLE() throws RecognitionException {
		try {
			int _type = VARIABLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:537:10: ( '?' LETTER ( ANY_CHAR )* )
			// Pddl.g:537:12: '?' LETTER ( ANY_CHAR )*
			{
			match('?'); 
			mLETTER(); 

			// Pddl.g:537:23: ( ANY_CHAR )*
			loop3:
			while (true) {
				int alt3=2;
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			int _type = NUMBER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Pddl.g:539:8: ( ( '-' )? ( DIGIT )+ ( '.' ( DIGIT )+ )? )
			// Pddl.g:539:10: ( '-' )? ( DIGIT )+ ( '.' ( DIGIT )+ )?
			{
			// Pddl.g:539:10: ( '-' )?
			int alt4=2;
	...
	static final String DFA11_eotS =
		...
		"\uffff\3\30\1\132\16\30\1\152\7\30\12\uffff\1\57\1\171\1\30\1\173\2\30"+
		"\1\uffff\4\30\1\u0082\10\30\1\u008b\1\30\1\uffff\10\30\5\uffff\1\57\1"+
		"\uffff\1\30\1\uffff\6\30\1\uffff\10\30\1\uffff\1\30\1\u00ad\5\30\1\u00b3"+
		"\1\30\7\uffff\1\57\12\30\1\u00c5\5\30\1\uffff\4\30\1\u00cf\1\uffff\1\30"+
		"\4\uffff\1\57\1\u00d8\1\u00d9\2\30\1\u00dc\1\u00dd\1\u00de\1\u00df\1\u00e0"+
		"\2\30\1\uffff\4\30\1\u00e7\4\30\1\uffff\1\u00ed\5\uffff\1\57\1\30\2\uffff"+
		"\2\30\5\uffff\6\30\1\uffff\1\30\1\u00fe\3\30\3\uffff\1\u0104\2\uffff\1"+
