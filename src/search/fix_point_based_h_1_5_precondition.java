 ...
 * @author enrico
 */
public class fix_point_based_h_1_5_precondition extends fix_point_based_h_1_precondition {
    ...
    public fix_point_based_h_1_5_precondition(Conditions G, Set<GroundAction> A) throws Exception {
        super(G, A);
        this.G = G;
