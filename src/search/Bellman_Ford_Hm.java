                ...
                for (ExtendedAddendum ad : left.summations) {
                    if (ad.f != null) {
                        ...
                        for (GroundAction gr : pool) {
                            if (gr.getNumericFluentAffected().get(ad.f)!=null){
...
//                    System.out.println("Comparison:"+cond+"cannot be satisfied");
                ...
                switch (comp.getComparator()) {
                    ...
                    case ">=":
                        ...
                        break;
                    case "<":
                        opt.Add(ctx.mkLe(expr, ctx.mkReal(1)));
                        break;
                    case "<=":
...
//                    System.out.println("Comparison:"+cond+"cannot be satisfied");
        ...
        for (int i=0;i < to_add2.length; i++){
            temp = ctx.mkAdd(temp,to_add2[i]);
        }
