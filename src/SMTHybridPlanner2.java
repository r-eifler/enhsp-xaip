...
public class SMTHybridPlanner2 {
    ...
    public static void parseInput(String[] args) {
        ...
        String usage = "usage:\n executable-name(java -jar...) "
                ...
                +"\n-s semantic used. From 0 to 3 with the following meaning:"
                +"\n       0: sequential semantic. Can be used for unit cost optimal planning buy is slow"
                + "\n      1: sequential semantic plus rolling-up"
